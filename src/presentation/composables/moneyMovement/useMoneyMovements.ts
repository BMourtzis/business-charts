import { CreateMoneyMovementCommandHandler } from "@/application/commands/moneyMovement/createMoneyMovementCommand";
...
export function useMoneyMovements() {
    ...
    return {
        ...
        createMoneyMovementCommandHandler: new CreateMoneyMovementCommandHandler(store)
    };
}